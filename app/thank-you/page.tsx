    ...
    <main className="bg-[#F2EDE2] py-16 text-[#9B4D32] md:py-24">
      <div className="mx-auto w-full max-w-[900px] px-6 md:px-10">
        <section className="text-center">
          <div
            className={`${styles.heroHeadlineShell} mx-auto inline-block rounded-2xl border border-[#9B4D32]/15 bg-white/25 px-6 py-4 shadow-[0_3px_14px_rgba(0,0,0,0.06)] md:px-8 md:py-5`}
          >
